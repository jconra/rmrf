...
export const ASSETS = [
  ...
  // Designer-built hull (submarine.config.js) + a grafted red sensor eye: the deep-water hazard
  // sub. Spawned by the game on demand, not grid-placed — this entry is so the asset designer can
  // view/measure the model. make() ignores the (cell, accent) args; the sub is team-neutral.
